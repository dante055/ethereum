  ...
  return (
    <div id="wallet" className="card">
      ...
      <div className="form-group row">
        ...
        {/* Wallet account : initially all tokens are mined abd deposited here
            then they are deposited into dex account for that tokenso that we can use then to exhange
        */}
